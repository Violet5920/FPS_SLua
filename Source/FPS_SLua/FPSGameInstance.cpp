...
DEFINE_LOG_CATEGORY(LogLuaInstance);
...
UFPSGameInstance::UFPSGameInstance() :state("main", this) {
	
}

void UFPSGameInstance::Init()
{
	UE_LOG(LogLuaInstance, Log, TEXT("\n Lua Start init \n"));

	state.onInitEvent.AddUObject(this, &UFPSGameInstance::LuaStateInitCallback);
	state.init();
...
void UFPSGameInstance::LuaStateInitCallback()
{
